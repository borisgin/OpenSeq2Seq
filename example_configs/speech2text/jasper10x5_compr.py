        ...
        "convnet_layers": [
            {
                ...
                "dilation":[1], "compression": 8, "dropout_keep_prob" : 0.8,
            },
            {
            ...
            },
            {
                ...
                "dilation":[1], "compression": 8, "dropout_keep_prob" : 0.7,
                "residual": True, "residual_dense": residual_dense
            },
            {
                "type": "conv1d", "repeat": 5,
            ...
            },
            {
                ...
                "dilation":[2], "compression": 8, "dropout_keep_prob" : 0.6,
            },
            {
                "type": "conv1d", "repeat": 1,
                "kernel_size": [1], "stride": [1],
                "num_channels": 1024, "padding": "SAME",
                "dilation":[1], "compression": 8, "dropout_keep_prob" : 0.6,
            }
        ],
...
train_params = {
    ...
    "data_layer_params": {
        "augmentation": {
            'speed_perturbation_ratio': [0.9, 1., 1.10],
        },
        "dataset_files": [
